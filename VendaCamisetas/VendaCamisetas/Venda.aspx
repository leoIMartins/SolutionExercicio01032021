<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Venda.aspx.cs" Inherits="VendaCamisetas.Venda" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server">
        <asp:GridView ID="GVCamisetas" runat="server" CellPadding="4" CssClass="table" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" OnRowCommand="GVCamisetas_RowCommand">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Vender">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" ID="btnVenderMidia" CommandName="VENDER" CommandArgument='<%# Eval("Id") %>' CssClass="btn btn btn-primary" Text="Vender" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
